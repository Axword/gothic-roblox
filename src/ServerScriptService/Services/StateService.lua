...
function StateService.default(): PlayerState
	return {schemaVersion=1, stats={level=1,xp=0,learningPoints=0,strength=5,dexterity=5,mana=20,maxHp=Formulae.maxHp(1,0),vitality=0},skills={sword=0,bow=0,lockpick=1,theft=0,skinning=0,spell=1},inventory={sword_01=1,bow_01=1,arrow_iron=12,lockpick=3,coin_zuzel=25},equipped="sword_01",quests={},flags={},reputation={kordon=0,wolnica=0},openedChests={},defeated={},worldTime=8}
end
