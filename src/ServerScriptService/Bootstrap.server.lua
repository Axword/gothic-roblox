...
local Constants=require(ReplicatedStorage.Shared.Constants);local DataIndex=require(ReplicatedStorage.Shared.DataIndex);local State=require(script.Services.StateService);local Save=require(script.Services.SaveService);local Combat=require(script.Services.CombatService);local Trainers=require(script.Services.TrainerService);local World=require(script.Services.WorldService)
